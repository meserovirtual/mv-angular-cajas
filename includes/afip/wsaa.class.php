...
class WSAA
{
    ...
    const CERT = "./keys/result.crt";            # The X.509 certificate in PEM format. Importante setear variable $path
    const PRIVATEKEY = "./keys/privada.key";    # The private key correspoding to CERT (PEM). Importante setear variable $path
    const PASSPHRASE = "";                        # The passphrase (if any) to sign
    const PROXY_ENABLE = false;
    //https://wsaahomo.afip.gov.ar/ws/services/LoginCms?WSDL // para obtener WSDL
	const URL = "https://wsaahomo.afip.gov.ar/ws/services/LoginCms?wsdl"; // homologacion (testing)
...
//    const URL = "https://wswhomo.afip.gov.ar/wsfev1/service.asmx?WSDL";
    ...
    const WSDL = "wsaa.orig.wsdl";                # The WSDL corresponding to WSAA
//    const WSDL = "wsaa.orig.wsdl";                # The WSDL corresponding to WSAA
